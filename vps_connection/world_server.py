...
async def region_socket(websocket: WebSocket, region_id: str, player_id: str = Query(default=""), display_name: str = Query(default="Guest"), session_token: str = Query(default="")):
